...
public class Permission extends RepoObject{
	...
	public Permission setModule(Package module) {
		this.module = module;
		return this;
	}
	...
	public static Permission getInstance(Authority authority, Package module, AccessRight accessRight){
