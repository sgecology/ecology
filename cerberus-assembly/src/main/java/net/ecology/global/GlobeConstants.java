...
public interface GlobeConstants {
  static final String PROP_REPO_DIR = "propRepoDir";
  ...
  static final String REPOSITORY_RESERVED = "repositoryReserved";
  static final String REPOSITORY_MASTER_CONFIG = "repositoryMasterConfig";
  ...
  static final String CACHE_IO_CONTAINER = "cacheIOContainer";
