...
(function() {
    ...
    var t = this,
        ...
        e = function(t) {
            ...
            this.width = i(t.canvas, "Width") || t.canvas.width, this.height = i(t.canvas, "Height") || t.canvas.height;
    ...
    var s = e.helpers = {},
        ...
        C = (s.getAngleFromPoint = function(t, i) {
            var e = i.x - t.x,
                s = i.y - t.y,
                n = Math.sqrt(e * e + s * s),
        ...
        x = (s.splineCurve = function(t, i, e, s) {
        ...
        y = (s.calculateScaleRange = function(t, i, e, s, o) {
            var a = 2,
            ...
            for (var d = Math.abs(u - c), p = x(d), f = Math.ceil(u / (1 * Math.pow(10, p))) * Math.pow(10, p), v = s ? 0 : Math.floor(c / (1 * Math.pow(10, p))) * Math.pow(10, p), S = f - v, C = Math.pow(10, p), y = Math.round(S / C);
                (y > h || h > 2 * y) && !l;)
                if (y > h) C *= 2, y = Math.round(S / C), y % 1 !== 0 && (l = !0);
                else if (o && p >= 0) {
                if (C / 2 % 1 !== 0) break;
                C /= 2, y = Math.round(S / C)
            } else C /= 2, y = Math.round(S / C);
            return l && (y = a, C = S / y), {
                steps: y,
                stepValue: C,
                min: v,
    ...
    e.instances = {}, e.Type = function(t, i, s) {
        ...
        generateLegend: function() {
            return s.template(this.options.legendTemplate, this)
        },
        destroy: function() {
                ...
                if (this.activeElements = t, this.draw(), this.options.customTooltips && this.options.customTooltips(!1), t.length > 0)
                    if (this.datasets && this.datasets.length > 1) {
                        ...
                        new e.MultiTooltip({
                            ...
                            title: y(this.options.tooltipTitleTemplate, t[0]),
                            chart: this.chart,
                            ctx: this.chart.ctx,
        ...
        buildYLabels: function() {
            this.yLabels = [];
            for (var t = v(this.stepValue), i = 0; i <= this.steps; i++) this.yLabels.push(y(this.templateString, {
        ...
        draw: function() {
            ...
            this.display && (t.fillStyle = this.textColor, t.font = this.font, n(this.yLabels, function(n, o) {
                ...
                var s = this.calculateX(e) + C(this.lineWidth),
                    n = this.calculateX(e - (this.offsetGridLines ? .5 : 0)) + C(this.lineWidth),
        ...
        setScaleSize: function() {
            var t, i, e, s, n, o, a, h, l, r, c, u, d = m([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]),
                p = this.width,
                g = 0;
            for (this.ctx.font = W(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), i = 0; i < this.valuesCount; i++) t = this.getPointPosition(i, d), e = this.ctx.measureText(y(this.templateString, {
                value: this.labels[i]
            ...
            if (this.display) {
                ...
                if (n(this.yLabels, function(i, e) {
                    ...
                    for (var i = this.valuesCount - 1; i >= 0; i--) {
                        var e = null,
                            s = null;
                        if (this.angleLineWidth > 0 && i % this.angleLineInterval === 0 && (e = this.calculateCenterOffset(this.max), s = this.getPointPosition(i, e), t.beginPath(), t.moveTo(this.xCenter, this.yCenter), t.lineTo(s.x, s.y), t.stroke(), t.closePath()), this.backgroundColors && this.backgroundColors.length == this.valuesCount) {
                ...
                this.ScaleClass = i.Scale.extend({
                    ...
                    this.datasets.push(n), e.each(i.data, function(e, s) {
                        n.bars.push(new this.BarClass({
                            ...
                            strokeColor: "object" == typeof i.strokeColor ? i.strokeColor[s] : i.strokeColor,
                            fillColor: "object" == typeof i.fillColor ? i.fillColor[s] : i.fillColor,
                            highlightFill: i.highlightFill ? "object" == typeof i.highlightFill ? i.highlightFill[s] : i.highlightFill : "object" == typeof i.fillColor ? i.fillColor[s] : i.fillColor,
                            highlightStroke: i.highlightStroke ? "object" == typeof i.highlightStroke ? i.highlightStroke[s] : i.highlightStroke : "object" == typeof i.strokeColor ? i.strokeColor[s] : i.strokeColor
                        }))
                    }, this)
