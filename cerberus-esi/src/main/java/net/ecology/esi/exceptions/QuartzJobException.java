package net.ecology.esi.exceptions;
...
public class QuartzJobException extends RuntimeException {
  private static final long serialVersionUID = -8754308854561912207L;
   ...
   * @since 1.7
   */
  protected QuartzJobException(String message, Throwable cause,
