...
import net.ecology.model.CurrencyRateType;
 ...
 */
@MappedSuperclass
public class TenderBase extends RepoObject {
    ...
    private String docCurrency = GlobeConstants.SYSTEM_CURRENCY_CODE;//dökümanın döviz tipi bilgisini tutar.
