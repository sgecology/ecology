...
import net.ecology.model.DistributionStyle;
 ...
 */
@MappedSuperclass
public class TenderDetailBase extends RepoObject {
	...
	public Tax getOTVTax() {
		...
		return getProduct() != null ? getProduct().getJITProductProfileTax().getOTVTax() : null;
	}
