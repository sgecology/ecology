...
public interface TokenAuthenticationService {
  ...
  */
  String generateToken(UserAccountDetails authenticationDetails);
  ...
  * @return String Generated JWeb token.
  */
  String generateIndefiniteToken(UserAccountDetails authenticationDetails);
  ...
  */
  UserAccountDetails resolve(String jWebToken);
