 ...
 * @author bqduc
 */
public class AuthException extends RuntimeException/*AuthenticationException*/ {
   ...
   * call to {@link #initCause}.
   */
  public AuthException(EcosExceptionCode authCode) {
   ...
   *          later retrieval by the {@link #getMessage()} method.
   */
  public AuthException(EcosExceptionCode authenticationCode, String message) {
      super(message);
