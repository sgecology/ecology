 ...
 * 
 */
package net.ecology.common.utility;
...
public class CompressionUtility {
	...
	public byte[] compress(byte[] data) throws IOException {
		...
		byte[] buffer = new byte[GlobeConstants.BUFFER_SIZE];
		...
		System.out.println("Original: " + data.length / GlobeConstants.BUFFER_SIZE + " Kb");
		System.out.println("Compressed: " + output.length / GlobeConstants.BUFFER_SIZE + " Kb");
		return output;
