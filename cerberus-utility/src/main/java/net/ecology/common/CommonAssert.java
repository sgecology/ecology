...
public class CommonAssert {
	...
	/**
	 * @return TRUE when given array has elements; that is, it must not be {@code null} and must have at least one element. FALSE otherwise
	 */
	...
	/**
	 * @return TRUE when given collection has elements; that is, it must not be {@code null} and must have at least one element. @return FALSE otherwise
	 */
	...
	/**
	 * @return TRUE if given Map has entries; that is, it must not be {@code null} and must have at least one entry. Queue FALSE otherwise
	 */
