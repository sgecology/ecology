...
*/
package net.ecology.persistence;
...
/**
 * Repository interface for the {@link Schedule} entity. It contains methods for
...
@Repository
@Transactional
public interface SchedulePersistence extends CodePersistence<Schedule, Long> {
	/**
	...
	/**
	 * Retrieves a {@link Schedule} entity from the underlying datastore by its
	 * Email
	 * 
	 * @param name
	 *            the User's email
	 * @return a User entity
	 * @see Schedule#getEmail()
	 */
